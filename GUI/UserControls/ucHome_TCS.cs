...
namespace GUI.UserControls
{
    public partial class ucHome_TCS : UserControl
    {
        ...
        private void butLocTL_Click(object sender, EventArgs e)
        {
        ...
        private void butLocMS_Click(object sender, EventArgs e)
        {
            List<SACH> Res = new List<SACH>();
        ...
        private void butLocTT_Click(object sender, EventArgs e)
        {
